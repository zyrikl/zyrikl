/*
Copyright (C) 2025, Zyrikl, Inc. This software may not be edited without permission from
the authors. Permission may be granted from Charles Wang (Zyrikl). This software is provided
...
function runner(prototype) {
    ...
    for (var a = 0; a < linesList.length; a++) {
        ...
        openBeginEnd1("p", "text", lineSplit);
        openBeginEnd1("h1", "title", lineSplit);
        openBeginEnd1("h2", "header_1", lineSplit);
        openBeginEnd1("h3", "header_2", lineSplit);
        openBeginEnd1("h4", "header_3", lineSplit);
        openBeginEnd1("h5", "header_4", lineSplit);
        openBeginEnd1("h6", "header_5", lineSplit);
...
<html>
    ...
    htmlWebOutput += "</cdn>";
    document.body.innerHTML=htmlWebOutput;
    document.querySelector("cdn").insertAdjacentHTML("beforebegin",requiredHTML1);
    document.querySelector("cdn").insertAdjacentHTML("afterend",requiredHTML2);
}
